...
HM_TEMPLATES = [
    ...
    ('rmnas10', HM_TEMPLATE_RMNAS10),
    ('rswint', HM_TEMPLATE_RSWINT),
]
...
for (name, template) in HM_TEMPLATES:
    for g in (False, True):
        for r in (False, ):  # we nolonger support r=True (fix_anchor)
            for hm in ('et', ):  # l2 and kl do not work
