#!/bin/sh
set -e
config="sop:rres18ghmetsmi:ptripletN"
ckpt="logs_sop-rres18ghmetsmi-ptripletN/lightning_logs/version_0/checkpoints/epoch=74-step=39900.ckpt"
...
python3 tools/pjswipe.py logs_sop-rres18ghmetsmi-ptripletN
