#!/bin/sh
set -e
config="cub:rres18ghmetsmi:ptripletN"
ckpt="logs_cub-rres18ghmetsmi-ptripletN/lightning_logs/version_0/checkpoints/epoch=74-step=3975.ckpt"
...
python3 tools/pjswipe.py logs_cub-rres18ghmetsmi-ptripletN
